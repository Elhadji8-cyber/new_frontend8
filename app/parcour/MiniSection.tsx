...
export const MiniSection = function(){
    return(
        <section className="flex flex-col justify-center items-center p-3 mt-5 bg-neutral-300">
             <div className="flex flex-col lg:flex-row md:flex-row lg:justify-evenly gap-5 items-center  p-2 mt-5 w-full">
            <main className="flex flex-col items-center py-4 lg:w-75 w-full bg-black text-white rounded-xl hover:shadow-lg transition-shadow duration-300">
