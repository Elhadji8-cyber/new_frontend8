...
export const NosValeurs = function(){
    return(
        <section className="flex flex-col bg-neutral-200 justify-center items-center gap-3 p-5 mt-5 md:mt-15 lg:mt-20">
            <h2 className={`text-4xl md:text-3xl lg:text-6xl p-1 ${amaranth.className} mt-3 font-bold`}>Nos Valeurs</h2>
            <article className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mt-5 p-3">
                ...
                className="bg-white rounded-xl p-2 w-full lg:w-85.5 hover:shadow-xl transition-shadow duration-300">
                  ...
                  <h4 className="text-xl font-bold p-1">Innovation</h4>
                  <p>Nous adoptons les dernières 
                ...
                className="bg-white rounded-xl p-2 w-full lg:w-85.5 hover:shadow-xl transition-shadow duration-300">
                 ...
                 <h4 className="text-xl font-bold p-1">Excellence</h4>
                 <p>Nos formateurs sont des experts reconnus
                ...
                className="bg-white rounded-xl p-2 w-full lg:w-85.5 hover:shadow-xl transition-shadow duration-300">
                  ...
                  <h4 className="text-xl font-bold p-1">Accompagnement</h4>
                  <p>Chaque apprenant bénéficie d'un suivi 
                ...
                className="bg-white rounded-xl p-2 w-full lg:w-85.5 hover:shadow-xl transition-shadow duration-300"> 
                 ...
                 <h4 className="text-xl font-bold p-1">Accessibilité</h4>
                 <p>Nos formations en ligne sont accessibles
