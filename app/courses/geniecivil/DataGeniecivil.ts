...
const DataGenicivil: CardData[] = [
...

    {
        ...
        titre: "Génie civil",
        best: "Nouveaux",
        time: "15h00", // Vous pouvez ajuster la durée
        image: "/image/FORMATION EN BETON PRECONTRAINT.jpg",
        title: "Formation Dalle Béton Précontraint : De Zéro à Expert Certifié ",
        title2: "Formation Dalle Béton Précontraint : De Zéro à Expert Certifié",
        photo: "/image/security.jpeg",
        nom: "Adama Sympavy", // Remplacez si c'est un autre formateur
        description: "Maitrisez la conception et le calcul des dalles en béton précontraint avec des projets réels...",
        description2: "Grâce à une approche 100 % pratique, des exemples concrets et des exercices guidés, vous apprendrez à concevoir, modéliser et dimensionner des dalles en béton précontraint efficacement pour atteindre vos objectifs et développer des compétences très recherchées en bureau d'études.",
        minititre: "Béton Précontraint",
        prix: "150000",
        sousprix: "200000",
        pourcentage: "25%",
        link: "voir le cours",
        slug: "dalle-beton-precontraint",
        header: {
            letitre: "Formation Dalle Béton Précontraint : De Zéro à Expert",
            card: {
                vente: "best seller",
                likeicon: AiOutlineLike,
                review: "98% positive reviews (1.5k)",
                iconUser: RiAccountCircle2Line,
                student: "10,000 éléves",
                audioIcon: LuAudioLines,
                audio: "Français"
            },
            imagedesc: "/image/FORMATION DALLE PRECONTRAINTE.jpg",
            coursedetaille: "Cette formation sur les dalles en béton précontraint vous accompagne des concepts fondamentaux jusqu'aux techniques avancées de dimensionnement (post-tension). Vous apprendrez à évaluer les pertes de précontrainte, tracer les profils de câbles, vérifier les contraintes aux états limites (ELS et ELU) et optimiser les sections. Le cursus combine théorie pointue et études de cas pratiques pour vous rendre immédiatement opérationnel sur des projets d'envergure complexe.",
            asavoir: "Avoir de solides connaissances en résistance des matériaux (RDM) et en calcul des structures en béton armé classique. Une familiarité avec les Eurocodes 2 est recommandée.",
            detaille: [
                {
                    mintit: "Introduction au béton précontraint",
                    desc: "Principes fondamentaux, avantages par rapport au béton armé classique, technologies (pré-tension, post-tension) et matériaux (béton BHP, armatures actives).",
                },
                {
                    mintit: "Technologie et tracé des câbles",
                    desc: "Systèmes d'ancrage, gaines, coulis d'injection, et principes de tracé des câbles de précontrainte dans les dalles."
                },
                {
                    mintit: "Évaluation des pertes de précontrainte",
                    desc: "Calcul détaillé des pertes instantanées (frottement, recul d'ancrage, raccourcissement élastique) et des pertes différées (retrait, fluage, relaxation)."
                },
                {
                    mintit: "Vérifications aux États Limites de Service (ELS)",
                    desc: "Vérification des contraintes normales dans le béton, limitation de la fissuration et calcul des flèches sous chargement."
                },
                {
                    mintit: "Dimensionnement aux États Limites Ultimes (ELU)",
                    desc: "Calcul de la résistance en flexion, vérification de l'effort tranchant et résistance au poinçonnement des dalles précontraintes.",
                },
                {
                    mintit: "Projet complet : Modélisation et plan d'exécution",
                    desc: "Réalisation d'une modélisation complète sur logiciel, rédaction de la note de calcul et génération du plan de câblage et de ferraillage passif."
                }
            ],
            leprix: {
                priactu: "150000",
                ...
                tachecours: {
                    ...
                    doc: " Des fichiers ressources (notes de calcul, plans) pour vous faciliter la tâche.",
                    button: "commande"
                }
            }
        }
...

    {
        ...
        best: "Nouveaux",
        time: "14h30",
        image: "/image/FORMATION DALLE PLEINE SUR APPUIS PONCTUELS.jpg",
        title: "Formation Dalle Pleine sur Appuis Ponctuels : De Zéro à Expert Certifié ",
        title2: "Formation Dalle Pleine sur Appuis Ponctuels : De Zéro à Expert Certifié",
        photo: "/image/security.jpeg",
        nom: "Adama Sympavy",
        description: "Maîtrisez le calcul et le ferraillage des planchers-dalles (dalles pleines sur appuis ponctuels) avec des projets concrets...",
        description2: "Grâce à une approche 100 % pratique, des exemples concrets et des exercices guidés, vous apprendrez à concevoir, modéliser et dimensionner des dalles pleines sur appuis ponctuels (sans poutres) pour optimiser vos structures et gagner en expertise technique.",
        minititre: "Plancher-Dalle",
        prix: "120.000",
        sousprix: "150.000",
        pourcentage: "25%",
        link: "voir le cours",
        slug: "dalle-pleine-appuis-ponctuels",
        header: {
            letitre: "Formation Dalle Pleine sur Appuis Ponctuels : De Zéro à Expert",
            card: {
                vente: "best seller",
                likeicon: AiOutlineLike,
                review: "98% positive reviews (1.5k)",
            ...
            imagedesc: "/image/FORMATION DALLE PLEINE APPUIS.jpg",
            coursedetaille: "Cette formation dédiée aux dalles pleines sur appuis ponctuels (planchers-dalles) vous apprend à concevoir des planchers sans retombées de poutres. Vous aborderez les méthodes de calcul des sollicitations, la vérification approfondie au poinçonnement, le détail du ferraillage (armatures de flexion et de poinçonnement) ainsi que la modélisation sur des logiciels dédiés. Ce cours vous permettra de relever les défis de ce type de structure très prisé dans les bâtiments modernes.",
            asavoir: "Avoir des connaissances de base en béton armé et en résistance des matériaux (RDM). Une connaissance des principes généraux de calcul des dalles est un plus.",
            detaille: [
                {
                    mintit: "Introduction aux planchers-dalles",
                    desc: "Fonctionnement structurel, avantages et inconvénients des dalles sur appuis ponctuels (avec ou sans chapiteaux).",
                },
                {
                    mintit: "Évaluation des sollicitations",
                    desc: "Méthodes de calcul manuelles approchées et principes de répartition des moments (bandes sur appuis, bandes en travée)."
                },
                {
                    mintit: "Vérification au poinçonnement (ELU)",
                    desc: "Calcul des contraintes de cisaillement aux abords des poteaux et nécessité des armatures de poinçonnement selon l'Eurocode 2."
                },
                {
                    mintit: "Dimensionnement du ferraillage",
                    desc: "Calcul des sections d'armatures longitudinales (flexion) et choix/disposition des armatures transversales (gougeons, étriers, peignes de poinçonnement)."
                },
                {
                    mintit: "Vérifications de service (ELS)",
                    desc: "Contrôle de l'état de fissuration, limitation des contraintes et calcul estimatif de la flèche.",
                },
                {
                    mintit: "Projet complet et modélisation logicielle",
                    desc: "Modélisation d'un plancher-dalle complet, interprétation des cartographies d'efforts et réalisation des plans de détails."
                }
            ],
            leprix: {
                priactu: "120.000",
                ...
                tachecours: {
                    videodetail: "Plus de 65 vidéos bien détaillées.",
                    pratique: " Des cas pratiques bien expliqués.",
                    acces: "Accès à la communauté des Ingénieurs sur Discord.",
                    doc: " Des fichiers ressources pour vous faciliter la tâche dans vos projets réels.",
                    button: "commande"
                }
            }
        }
...

    {
        ...
        best: "Nouveaux",
        time: "18h00",
        image: "/image/FORMATION REVIT ROBOT.jpg",
        title: "Formation BIM : Revit Structure et Robot Structural Analysis ",
        title2: "Formation BIM : Revit Structure et Robot Structural Analysis",
        photo: "/image/security.jpeg",
        nom: "Adama Sympavy",
        description: "Maitrisez le flux de travail BIM complet : de la modélisation sur Revit au calcul sur Robot Structural Analysis...",
        description2: "Grâce à une approche 100 % pratique, découvrez l'interopérabilité parfaite entre Revit et Robot. Vous apprendrez à modéliser des structures complexes, exporter vers Robot pour le calcul et le dimensionnement, puis réimporter les résultats pour finaliser vos plans d'exécution et nomenclatures.",
        minititre: "Revit & Robot BIM",
        prix: "120.000",
        sousprix: "150.000",
        pourcentage: "25%",
        link: "voir le cours",
        slug: "revit-structure-robot-structural",
        header: {
            letitre: "Formation BIM : Revit Structure et Robot Structural",
            card: {
                vente: "best seller",
                likeicon: AiOutlineLike,
                review: "99% positive reviews (2.1k)",
                iconUser: RiAccountCircle2Line,
                student: "12,500 éléves",
                audioIcon: LuAudioLines,
                audio: "Français"
            },
            imagedesc: "/image/FORMATION REVIT ROBOT.jpg",
            coursedetaille: "Cette formation complète vous plonge au cœur du processus BIM (Building Information Modeling) pour l'ingénierie structurale. Vous débuterez par la création du modèle analytique et physique sous Revit Structure (Béton armé et Charpente métallique). Ensuite, vous découvrirez comment transférer ce modèle vers Robot Structural Analysis pour appliquer les charges, paramétrer les combinaisons, et lancer les calculs aux éléments finis. Enfin, vous apprendrez à dimensionner les éléments et à mettre à jour dynamiquement la maquette Revit pour la production des livrables.",
            asavoir: "Avoir des connaissances de base en conception et calcul de structures (RDM, Béton Armé ou Charpente). Aucune connaissance préalable de Revit ou Robot n'est strictement exigée, mais c'est un plus.",
            detaille: [
                {
                    mintit: "Modélisation physique sur Revit Structure",
                    desc: "Création de quadrillages, niveaux, poteaux, poutres, voiles, dalles et fondations. Gestion des vues et des familles.",
                },
                {
                    mintit: "Préparation du modèle analytique",
                    desc: "Ajustement des nœuds, définition des appuis, relâchements et vérification de la cohérence du modèle pour le calcul."
                },
                {
                    mintit: "Interopérabilité Revit - Robot",
                    desc: "Configuration des paramètres d'export, transfert du modèle vers Robot et gestion des éventuelles erreurs de maillage et d'importation."
                },
                {
                    mintit: "Analyse et calcul sur Robot Structural Analysis",
                    desc: "Application des charges (permanentes, exploitation, vent/séisme), création des combinaisons, maillage aux éléments finis et interprétation des résultats (cartographies, diagrammes)."
                },
                {
                    mintit: "Dimensionnement des éléments",
                    desc: "Calcul du ferraillage théorique et réel pour le béton armé, vérification et optimisation des profilés et des attaches pour la charpente métallique.",
                },
                {
                    mintit: "Mise à jour Revit et production des livrables",
                    desc: "Importation des résultats et armatures dans Revit, création des plans de coffrage, plans de ferraillage, détails d'assemblages et nomenclatures automatiques."
                }
            ],
            leprix: {
                priactu: "120.000",
                ...
                tachecours: {
                    videodetail: "Plus de 90 vidéos bien détaillées.",
                    pratique: " Des projets complets modélisés et calculés de A à Z.",
                    acces: "Accès VIP à la communauté d'ingénieurs sur Discord.",
                    doc: " Fichiers sources (fichiers RVT, modèles Robot) et gabarits BIM fournis.",
                    button: "commande"
                }
            }
        }
    ...
    {
        id: 31,//dentifiant mis à jour
        titre: "Génie civil",
        best: "Nouveaux",
        time: "16h00", // Vous pouvez ajuster la durée
        image: "/image/FORMATION ELECTRICTE.jpg",
        title: "Formation Revit Électricité (MEP) : De Zéro à Expert Certifié ",
        title2: "Formation Revit Électricité (MEP) : De Zéro à Expert Certifié",
        photo: "/image/security.jpeg",
        nom: "Adama Sympavy",
        description: "Maîtrisez la modélisation et la conception des réseaux électriques avec Revit MEP...",
        description2: "Grâce à une approche 100 % pratique, des exemples concrets et des exercices guidés, vous apprendrez à utiliser Revit pour concevoir, modéliser et documenter des installations électriques complètes (courants forts et courants faibles) dans le respect du processus BIM.",
        minititre: "Revit Électricité",
        prix: "100000",
        sousprix: "125000",
        pourcentage: "25%",
        link: "voir le cours",
        slug: "revit-electricite",
        header: {
            letitre: "Formation Revit Électricité : De Zéro à Expert",
            card: {
                vente: "best seller",
                likeicon: AiOutlineLike,
                review: "98% positive reviews (1.8k)",
                iconUser: RiAccountCircle2Line,
                student: "8,500 éléves",
                audioIcon: LuAudioLines,
                audio: "Français"
            },
            imagedesc: "/image/FORMATION ELECTRICTE.jpg",
            coursedetaille: "Cette formation Revit Électricité (MEP) vous accompagne dans la maîtrise de la maquette numérique pour les lots électriques. Vous apprendrez à implanter des équipements (tableaux, luminaires, prises), modéliser des réseaux de chemins de câbles et de conduits, créer des circuits électriques (puissance et éclairage), et équilibrer les charges. Le cours couvre également la génération automatique des nomenclatures de panneaux, le tracé des schémas et la production des plans d'exécution selon les standards BIM.",
            asavoir: "Avoir des connaissances de base en électricité du bâtiment (CFO/CFA). Une familiarité avec l'interface générale de Revit ou le dessin technique est recommandée mais non obligatoire.",
            detaille: [
                {
                    mintit: "Introduction à Revit MEP et configuration",
                    desc: "Prise en main de l'interface, liaison de la maquette architecturale, copie et contrôle des niveaux et quadrillages.",
                },
                {
                    mintit: "Implantation des équipements électriques",
                    desc: "Placement des luminaires, prises de courant, interrupteurs, appareils d'alarme et tableaux électriques (TGBT, divisionnaires)."
                },
                {
                    mintit: "Création et gestion des circuits électriques",
                    desc: "Connexion des équipements aux panneaux, gestion des systèmes de puissance et d'éclairage, et paramétrage des tensions."
                },
                {
                    mintit: "Modélisation des chemins de câbles et conduits",
                    desc: "Tracé 3D des réseaux de distribution, paramétrage des raccords, gestion des collisions et ajustement des élévations."
                },
                {
                    mintit: "Nomenclatures et équilibrage des panneaux",
                    desc: "Création des nomenclatures de tableaux électriques, analyse des charges, équilibrage des phases et vérification des puissances.",
                },
                {
                    mintit: "Documentation et production des plans",
                    desc: "Paramétrage des vues, étiquetage des équipements et des fils, création des légendes et mise en page sur cartouche pour l'impression."
                }
            ],
            leprix: {
                priactu: "100000",
                ...
                categori: {
                    categorie: "Catégories",
                    geniecivil: "Électricité / MEP", // Modifié pour plus de précision (peut être remis à "Génie Civil" si contrainte d'interface)
                    duree: "Durée",
                    heure: "16h00mn",
                    apprend: "Apprenants",
                    neleve: "8,500",
                ...
                tachecours: {
                    videodetail: "Plus de 80 vidéos bien détaillées.",
                    pratique: " Des cas pratiques d'installations courants forts / faibles.",
                    acces: "Accès à la communauté des projeteurs et ingénieurs sur Discord.",
                    doc: " Des gabarits (templates) Revit MEP et bibliothèques de familles électriques fournis.",
                    button: "commande"
                }
            }
        }
    ...
    {
        id: 32, // Identifiant mis à jour
        titre: "Génie civil",
        best: "Nouveaux",
        time: "15h30", // Vous pouvez ajuster la durée
        image: "/image/FORMATION plomberie.jpg",
        title: "Formation Revit Plomberie (MEP) : De Zéro à Expert Certifié ",
        title2: "Formation Revit Plomberie (MEP) : De Zéro à Expert Certifié",
        photo: "/image/security.jpeg",
        nom: "Adama Sympavy",
        description: "Maîtrisez la modélisation et la conception des réseaux de plomberie et sanitaires avec Revit MEP...",
        description2: "Grâce à une approche 100 % pratique, des exemples concrets et des exercices guidés, vous apprendrez à utiliser Revit pour concevoir, modéliser et documenter des installations de plomberie (eau froide, eau chaude, évacuations) dans le respect des processus BIM.",
        minititre: "Revit Plomberie",
        prix: "100000",
        sousprix: "120.000",
        pourcentage: "25%",
        link: "voir le cours",
        slug: "revit-plomberie",
        header: {
            letitre: "Formation Revit Plomberie : De Zéro à Expert",
            card: {
                vente: "best seller",
                likeicon: AiOutlineLike,
                review: "99% positive reviews (1.6k)",
                iconUser: RiAccountCircle2Line,
                student: "7,800 éléves",
                audioIcon: LuAudioLines,
                audio: "Français"
            },
            imagedesc: "/image/FORMATION plomberie.jpg",
            coursedetaille: "Cette formation Revit Plomberie (MEP) vous accompagne dans la maîtrise de la maquette numérique pour les lots fluides et sanitaires. Vous apprendrez à implanter des appareils sanitaires, créer des systèmes de canalisations (alimentation et réseaux gravitaires), gérer les pentes d'évacuation et dimensionner les tuyauteries. Le cours couvre également la détection de conflits (clashes), la génération automatique des nomenclatures de matériaux et la production de plans d'exécution isométriques et en plan selon les standards BIM.",
            asavoir: "Avoir des connaissances de base en plomberie du bâtiment (réseaux sous pression et gravitaires). Une familiarité avec l'interface générale de Revit ou le dessin technique est un atout, mais n'est pas obligatoire.",
            detaille: [
                {
                    mintit: "Introduction à Revit MEP et préparation du projet",
                    desc: "Prise en main de l'interface fluide, liaison de la maquette architecturale, copie et contrôle des appareils sanitaires existants.",
                },
                {
                    mintit: "Création des systèmes de plomberie",
                    desc: "Définition des systèmes logiques (Eau Froide Sanitaire, Eau Chaude Sanitaire, Évacuations des Eaux Usées/Vannes)."
                },
                {
                    mintit: "Modélisation des réseaux de canalisations",
                    desc: "Tracé 3D des tuyauteries, paramétrage des raccords automatiques, gestion des diamètres et connexion aux équipements sanitaires."
                },
                {
                    mintit: "Gestion des réseaux gravitaires (Évacuations)",
                    desc: "Modélisation des canalisations avec pente, réglage des déclivités, ajout de siphons, culottes et regards de visite."
                },
                {
                    mintit: "Dimensionnement et analyse des réseaux",
                    desc: "Utilisation des outils de dimensionnement intégrés, calcul des débits et pertes de charge, inspection des systèmes.",
                },
                {
                    mintit: "Documentation, synthèses et livrables",
                    desc: "Création de vues isométriques, étiquetage des canalisations, nomenclatures de tuyaux/raccords, et mise en page sur cartouche."
                }
            ],
            leprix: {
                priactu: "100000",
                ...
                categori: {
                    categorie: "Catégories",
                    geniecivil: "Plomberie / MEP", // Modifié pour plus de précision
                    duree: "Durée",
                    heure: "15h30mn",
                    apprend: "Apprenants",
                    neleve: "7,800",
                ...
                tachecours: {
                    ...
                    pratique: " Des cas pratiques d'installations sanitaires complètes.",
                    acces: "Accès à la communauté des projeteurs et ingénieurs sur Discord.",
                    doc: " Des gabarits Revit MEP et bibliothèques de familles de plomberie fournis.",
                    button: "commande"
                }
            }
        }
