...
export const CourseCard = function({course}: props){
    return(
        ...
        >
         <div className="relative w-full  bg-neutral-200 rounded-xl p-1  h-[70vh] md:h-[48vh] lg:h-[46vh] gap-5">   
         ...
         <h3 className="text-black text-xl lg:text-3xl md:text-xl font-bold mt-2">{course.title} </h3>
         <hr />
         ...
         <p className="text-black text-sm md:text-lg lg:text-xl p-1">{course.description} </p>
         <hr />
